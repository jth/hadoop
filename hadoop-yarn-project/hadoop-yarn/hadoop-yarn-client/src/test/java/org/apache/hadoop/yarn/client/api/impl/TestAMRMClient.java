...
public class TestAMRMClient {
  ...
  public static void setup() throws Exception {
    ...
    capability = Resource.newInstance(1024, 1, 1024);
  ...
  public void testAMRMClientMatchingFit() throws YarnException, IOException {
    ...
    try {
      ...
      Resource capability1 = Resource.newInstance(1024, 2, 1024);
      Resource capability2 = Resource.newInstance(1024, 1, 1024);
      Resource capability3 = Resource.newInstance(1000, 2, 1024);
      Resource capability4 = Resource.newInstance(2000, 1, 1024);
      Resource capability5 = Resource.newInstance(1000, 3, 1024);
      Resource capability6 = Resource.newInstance(2000, 1, 1024);
      Resource capability7 = Resource.newInstance(2000, 1, 1024);
      ...
      // exact match
      Resource testCapability1 = Resource.newInstance(1024,  2, 1024);
      ...
      Resource testCapability2 = Resource.newInstance(2000, 1, 1024);
      ...
      Resource testCapability4 = Resource.newInstance(1024, 2, 1024);
      ...
      Resource testCapability5 = Resource.newInstance(512, 4, 1024);
      ...
      // locations
      Resource testCapability7 = Resource.newInstance(2000, 1, 1024);
  ...
  public void testAMRMClientMatchingFitInferredRack() throws YarnException, IOException {
    ...
    try {
      ...
      Resource capability = Resource.newInstance(1024, 2, 1024);
  ...
  public void testAllocationWithBlacklist() throws YarnException, IOException {
    ...
    try {
      ...
      ContainerRequest invalidContainerRequest = 
          new ContainerRequest(Resource.newInstance(-1024, 1, 1024),
  ...
  public void testAskWithNodeLabels() {
    ...
    client.addContainerRequest(new ContainerRequest(Resource.newInstance(1024,
        1, 1024), null, null, Priority.UNDEFINED, true, "x"));
    ...
    client.addContainerRequest(new ContainerRequest(Resource.newInstance(1024,
        1, 1024), null, null, Priority.UNDEFINED, true, "x"));
    client.addContainerRequest(new ContainerRequest(Resource.newInstance(1024,
        1, 1024), null, null, Priority.UNDEFINED, true, "a"));
    Assert.assertEquals(1, client.ask.size());
    ...
    // add exp=x then add exp=a to ANY in same priority, only exp=a should kept
    client.addContainerRequest(new ContainerRequest(Resource.newInstance(1024,
        1, 1024), null, null, Priority.UNDEFINED, true,
        "y"));
    Assert.assertEquals(1, client.ask.size());
  ...
  public void testAskWithInvalidNodeLabels() {
    ...
    verifyAddRequestFailed(client,
        new ContainerRequest(Resource.newInstance(1024, 1, 1024), null, null,
