...
public class TestGreedyReservationAgent {
  ...
  InMemoryPlan plan;
  Resource minAlloc = Resource.newInstance(1024, 1, 1024);
  ResourceCalculator res = new DefaultResourceCalculator();
  Resource maxAlloc = Resource.newInstance(1024 * 8, 8, 1024);
  ...
  public void setup() throws Exception {
    ...
    Resource clusterCapacity = Resource.newInstance(100 * 1024, 100, 1024);
    step = 1000L;
  ...
  public void testSimple() throws PlanningException {
    ...
    ReservationRequest r = ReservationRequest.newInstance(
        Resource.newInstance(2048, 2, 1024), 10, 5, 10 * step);
    ...
    for (long i = 10 * step; i < 20 * step; i++) {
      assertTrue(
          ...
          Resources.equals(cs.getResourcesAtTime(i),
              Resource.newInstance(2048 * 10, 2 * 10, 1024)));
    }
  ...
  public void testOrder() throws PlanningException {
    ...
    ReservationRequest r = ReservationRequest.newInstance(
        Resource.newInstance(2048, 2, 1024), 10, 1, 10 * step);
    ReservationRequest r2 = ReservationRequest.newInstance(
        Resource.newInstance(1024, 1, 1024), 10, 10, 20 * step);
  ...
  public void testOrderNoGapImpossible() throws PlanningException {
    ...
    ReservationRequest r = ReservationRequest.newInstance(
        Resource.newInstance(2048, 2, 1024), 10, 1, 10);
    ReservationRequest r2 = ReservationRequest.newInstance(
        Resource.newInstance(1024, 1, 1024), 10, 10, 20);
    List<ReservationRequest> list = new ArrayList<ReservationRequest>();
    list.add(r);
    list.add(r2);
    list.add(r);
  ...
  public void testSingleSliding() throws PlanningException {
    ...
    ReservationRequest r = ReservationRequest.newInstance(
        Resource.newInstance(1024, 1, 1024), 200, 10, 10 * step);
  ...
  public void testAny() throws PlanningException {
    ...
    ReservationRequest r = ReservationRequest.newInstance(
        Resource.newInstance(1024, 1, 1024), 5, 5, 10 * step);
    ReservationRequest r2 = ReservationRequest.newInstance(
        Resource.newInstance(2048, 2, 1024), 10, 5, 10 * step);
    ReservationRequest r3 = ReservationRequest.newInstance(
        Resource.newInstance(1024, 1, 1024), 110, 110, 10 * step);
  ...
  public void testAnyImpossible() throws PlanningException {
    ...
    ReservationRequest r1 = ReservationRequest.newInstance(
        Resource.newInstance(1024, 1, 1024), 35, 5, 30);
    // above max cluster size
    ReservationRequest r2 = ReservationRequest.newInstance(
        Resource.newInstance(1024, 1, 1024), 110, 110, 10);
  ...
  public void testAll() throws PlanningException {
    ...
    ReservationRequest r = ReservationRequest.newInstance(
        Resource.newInstance(1024, 1, 1024), 5, 5, 10 * step);
    ReservationRequest r2 = ReservationRequest.newInstance(
        Resource.newInstance(2048, 2, 1024), 10, 10, 20 * step);
  ...
  public void testAllImpossible() throws PlanningException {
    ...
    reqs.setInterpreter(ReservationRequestInterpreter.R_ALL);
    ReservationRequest r = ReservationRequest.newInstance(
        Resource.newInstance(1024, 1, 1024), 55, 5, 10);
    ReservationRequest r2 = ReservationRequest.newInstance(
        Resource.newInstance(2048, 2, 1024), 55, 5, 20);
  ...
  private boolean check(ReservationAllocation cs, long start, long end,
    ...
    for (long i = start; i < end; i++) {
      res = res
          && Resources.equals(cs.getResourcesAtTime(i),
              Resource.newInstance(mem * containers, cores * containers, 1024));
    }
    return res;
  }
  ...
  public void testStress(int numJobs) throws PlanningException, IOException {
    ...
    long timeWindow = 1000000L;
    Resource clusterCapacity = Resource.newInstance(500 * 100 * 1024, 500 * 32, 1024);
    step = 1000L;
    ReservationSystemTestUtil testUtil = new ReservationSystemTestUtil();
