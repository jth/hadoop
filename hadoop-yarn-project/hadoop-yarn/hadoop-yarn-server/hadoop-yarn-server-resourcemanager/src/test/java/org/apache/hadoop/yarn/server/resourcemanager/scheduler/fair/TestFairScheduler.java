...
public class TestFairScheduler extends FairSchedulerTestBase {
  ...
  public void testMoveRunnableApp() throws Exception {
    ...
    assertEquals(Resource.newInstance(1024, 1, 1024), oldQueue.getResourceUsage());
    scheduler.update();
    assertEquals(Resource.newInstance(3072, 3, 1024), oldQueue.getDemand());
    ...
    assertEquals(Resource.newInstance(0, 0, 1024), oldQueue.getResourceUsage());
    assertEquals(Resource.newInstance(1024, 1, 1024), targetQueue.getResourceUsage());
    ...
    scheduler.update();
    assertEquals(Resource.newInstance(0, 0, 1024), oldQueue.getDemand());
    assertEquals(Resource.newInstance(3072, 3, 1024), targetQueue.getDemand());
  }
