...
public class TestRMNodeLabelsManager extends NodeLabelTestBase {
  private final Resource EMPTY_RESOURCE = Resource.newInstance(0, 0, 1024);
  private final Resource SMALL_RESOURCE = Resource.newInstance(100, 0, 1024);
  private final Resource LARGE_NODE = Resource.newInstance(1000, 0, 1024);
  ...
  public void testGetQueueResource() throws Exception {
    Resource clusterResource = Resource.newInstance(9999, 1, 1024);
  ...
  public void testPullRMNodeLabelsInfo() throws IOException {
    ...
    mgr.activateNode(NodeId.newInstance("n1", 1), Resource.newInstance(10, 0, 1024));
    mgr.activateNode(NodeId.newInstance("n2", 1), Resource.newInstance(10, 0, 1024));
    mgr.activateNode(NodeId.newInstance("n3", 1), Resource.newInstance(10, 0, 1024));
    mgr.activateNode(NodeId.newInstance("n4", 1), Resource.newInstance(10, 0, 1024));
    mgr.activateNode(NodeId.newInstance("n5", 1), Resource.newInstance(10, 0, 1024));
  ...
  public void testLabelsToNodesOnNodeActiveDeactive() throws Exception {
    ...
    mgr.activateNode(NodeId.newInstance("n1", 2), Resource.newInstance(10, 0, 1024));
    // p1 -> n1, n1:1, n1:2
